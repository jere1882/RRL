...
def get_optimal_parameters_imb(kernel="linear"):
    ...
    if (kernel=="linear" or kernel=="svml"):
        optimal["C"]=get_optimal_parameters_fs("svml")["C"]
        optimal["n_bins"]=get_optimal_parameters_fs("svml")["n_bins"]
        optimal["k"]=get_optimal_parameters_fs("svml")["k"]  
        optimal["fc"]=get_optimal_parameters_fs("svml")["fc"]  
        ...
        optimal["k"]=get_optimal_parameters_fs("svmk")["k"]       
        optimal["fc"]=get_optimal_parameters_fs("svmk")["fc"]  
